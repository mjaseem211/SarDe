...
Widget Success() {
  return Stack(alignment: Alignment.center, children: [
    ...
    Padding(
      padding: EdgeInsets.only(left: 121.w, right: 111.w),
    ...
    Padding(
      padding: EdgeInsets.only(top: 209.h, left: 75.w, right: 75.w),
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
          alignment: Alignment.center,
          child: Text("Good Job",
              style: TextStyle(
                color: Color(0XFF52972A),
                fontWeight: FontWeight.w400,
                fontSize: 35.sp,
              )),
        ),
    ...
    Padding(
      padding: EdgeInsets.only(top: 264.h, left: 44.w, right: 43.w),
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
          alignment: Alignment.center,
          child: Text("Job 303 Kuttichira to Maradu day 21.03.21 Completed",
              style: TextStyle(
                color: Color(0XFF2B3070).withOpacity(.7),
                fontWeight: FontWeight.w400,
                fontSize: 9.sp,
              )),
        ),
